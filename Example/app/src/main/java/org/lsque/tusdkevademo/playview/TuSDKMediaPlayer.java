...
public class TuSDKMediaPlayer extends FrameLayout {
    ...
    public void seekToPercentage(float percent){
        if (this.mMediaPlayer != null && percent <=1 && percent >= 0){
            this.mMediaPlayer.seekTo((int) (this.mMediaPlayer.getDuration() * percent));
        }
    }
